...
** The score starts at 15 because it allows the player to either loose or
*progress a mesurable amount
*/
...
void broker_new_hand(t_game *g) { g->broker = 14 + (rand() % 8); }
...
d_bool is_game_finished(t_game *g) { return g->end; }

void game_end(t_game *g) { g->end = 1; }
